...
public class VictoriaHospitalSystem {
	public static void main(String[] args) {
		...
		Patient [] admissionsJan13 = new Patient[12];
		...
		String [] meds = {"a", "visine"};
		Patient lillAnne = new Patient("LillAnne Jackson", "AB",1, 12, 1995, meds);
		...
		System.out.println(lillAnne);

		System.out.println("  This patient's medications:  " + lillAnne.getCurrentMedications());
