...
public class a2tester
{
	...
	{
		boolean 	passed;
		GeneralList<Integer> 	l = createNewList();
	...
	public static void addArray (int[] a, GeneralList<Integer> l, boolean addBack)
	{
	...
	{
		int[]		a1 = {7,1,18};
		GeneralList<Integer>	l1 = createNewList();
		GeneralList<Integer>	l2 = createNewList();
	...
	public static GeneralList<Integer> createNewList()
	{
		if (testArraySolution)
		{
			//return new IntegerArrayList();
			return new SLL<Integer>();
		}
		else
		{
