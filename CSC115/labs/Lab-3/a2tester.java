...
public class a2tester
{
	...
	public static void addArray (int[] a, IntegerSLL l, boolean addBack)
	{
	...
	{
		int[]		a1 = {7,1,18};
		IntegerSLL	l1 = createNewList();
		IntegerSLL	l2 = createNewList();
	...
	public static IntegerSLL createNewList()
	{
		if (testArraySolution)
		{
			return new IntegerSLL();
		}
		else
		{
			return new IntegerSLL();
