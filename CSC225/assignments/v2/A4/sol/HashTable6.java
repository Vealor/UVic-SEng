/* 
   ...
   You should complete this file with the implementation for part 6.
...
public class HashTable6{
	...
	*/
	public int hashTwo(String s){
		...
		long hashedValue = (11+asciiValue) % TableSize;
		return (int)hashedValue;
	}
	/* hashThree(s)
	   Return the hash code for the provided string.
	...
	*/
	public int hashThree(String s){
		...
		long hashedValue = (7+asciiValue) % TableSize;
		return (int)hashedValue;
	}
	/* insert(s)
	...
	*/
	public int insert(String s){
		...
		while(T.getElement(i) != null){
			i += ((hashcount * k) + ((hashcount*hashcount-hashcount) * m));
			hashcount++;
			if (i >= TableSize)
				i = i%TableSize;
		}
